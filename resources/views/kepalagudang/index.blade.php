          ...
          <li class="dropdown pc-h-item header-user-profile">
            ...
            <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
              <div class="dropdown-header">
                <h4>Selamat Datang, <span class="small text-muted"> Kepala Gudang</span></h4>
                <p class="text-muted">Kepala Gudang</p>
                <hr />
      ...
      <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
          <ul class="pc-navbar">
            ...
            <li class="pc-item">
              <a href="peminjamankp" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-file-circle-plus"></i></span><span class="pc-mtext">Peminjaman</span></a>
            </li>
            ...
            <li class="pc-item">
              <a href="laporankp" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-book"></i></span><span class="pc-mtext">Generate Laporan</span></a>
            </li>
          </ul>
        </div>
      </div>
