          ...
          <li class="dropdown pc-h-item header-user-profile">
            ...
            <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
              <div class="dropdown-header">
                <h4>Selamat Datang, <span class="small text-muted"> Administrator</span></h4>
      ...
      <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
          <ul class="pc-navbar">
            ...
            <li class="pc-item">
              <a href="petugas" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-users"></i></span><span class="pc-mtext">Petugas</span></a>
            </li>
            <li class="pc-item">
              <a href="anggota" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-user-group"></i></i></span><span class="pc-mtext">Anggota</span></a>
            </li>
            <li class="pc-item pc-caption">
              <label>Inventaris</label>
            </li>
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-boxes-stacked"></i></span><span
                  class="pc-mtext">Inventarisir</span><span class="pc-arrow"><i class="ti ti-chevron-right"></i></span></a>
              <ul class="pc-submenu">
                <li class="pc-item"><a class="pc-link" href="inventaris">Inventaris</a></li>
                <li class="pc-item"><a class="pc-link" href="ruang">Ruang</a></li>
                <li class="pc-item"><a class="pc-link" href="jenis">Jenis</a></li>
              </ul>
            </li>
            <li class="pc-item">
              <a class="pc-link" href="/peminjamanadmin"><span class="pc-micon"><i class="fa-solid fa-file-circle-plus"></i></span><span class="pc-mtext">Peminjaman</span></a>
            </li>
            <li class="pc-item">
              <a href="pengembalianadmin" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-file-circle-check"></i></span><span class="pc-mtext">Pengembalian</span><span class="pc-arrow"></a>
            </li>
            <li class="pc-item pc-caption">
              <label>Laporan</label><i class="ti ti-dashboard"></i>
            </li>
            <li class="pc-item">
              <a href="laporanadmin" class="pc-link"><span class="pc-micon"><i class="fa-solid fa-book"></i></span><span class="pc-mtext">Generate Laporan</span></a>
            </li>
          </ul>
        </div>
      </div>
