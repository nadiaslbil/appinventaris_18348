  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        ...
        <form action="updateanggota" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nama_anggota" class="form-control" placeholder="Nama Anggota" value="{{ $d->nama_anggota }}">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label">NIS</label>
                        <div class="col-sm-10">
                          <input type="number" name="no_anggota" class="form-control" placeholder="NIS" value="{{ $d->no_anggota }}">
                      </div>
                </div>
                <div class="mb-3 row">
